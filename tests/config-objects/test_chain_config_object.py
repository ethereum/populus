...
@pytest.mark.parametrize(
    ...
    (
        ...
        ('populus.chain.LocalGethChain', 'populus.chain.geth.LocalGethChain'),
        ('populus.chain.ExternalChain', 'populus.chain.external.ExternalChain'),
        ('populus.chain.TesterChain', 'populus.chain.tester.TesterChain'),
        ('populus.chain.TestRPCChain', 'populus.chain.testrpc.TestRPCChain'),
        ('populus.chain.TemporaryGethChain', 'populus.chain.geth.TemporaryGethChain'),
        ('populus.chain.MainnetChain', 'populus.chain.geth.MainnetChain'),
        ('populus.chain.TestnetChain', 'populus.chain.geth.TestnetChain'),
