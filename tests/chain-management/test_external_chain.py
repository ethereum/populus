...
def test_external_chain(project):
    ...
    project.config['chains.external.web3.provider.class'] = 'web3.providers.tester.EthereumTesterProvider'  # noqa: E501
    ...
    with project.get_chain('external') as external_chain:
        pass  # assert isinstance(external_chain.web3.currentProvider, EthereumTesterProvider)
