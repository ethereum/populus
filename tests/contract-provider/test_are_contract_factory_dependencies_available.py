...
def test_contract_factory_availability_with_no_dependencies(tester_chain,
                                                            math):
    chain = tester_chain
...
def test_contract_factory_availability_with_missing_dependency(tester_chain,
                                                               multiply_13):
    chain = tester_chain
    provider = chain.store.provider
...
def test_contract_factory_availability_with_bytecode_mismatch_on_dependency(tester_chain,
                                                                            multiply_13,
                                                                            math):
    chain = tester_chain
    provider = chain.store.provider
...
def test_contract_factory_availability_with_dependency(tester_chain,
                                                       multiply_13,
                                                       library_13):
    chain = tester_chain
    provider = chain.store.provider
