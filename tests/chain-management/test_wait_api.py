...
def test_wait_for_contract_address(project,
                                   chain_name,
                                   wait_for_unlock):
    MATH_BYTECODE = project.compiled_contract_data['contracts']['Math']['bytecode']
    MATH_BYTECODE_RUNTIME = project.compiled_contract_data['contracts']['Math']['bytecode_runtime']
