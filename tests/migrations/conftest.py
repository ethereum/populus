...
CONTRACT_THROWER_CODE = "0x606060405260405160208060318339506080604052518015601e576002565b50600680602b6000396000f3606060405200"
...
@pytest.fixture()
def THROWER(THROWER_CODE,
            THROWER_RUNTIME,
            THROWER_ABI,
            THROWER_SOURCE):
    return {
        'code': THROWER_CODE,
        'code_runtime': THROWER_RUNTIME,
        'abi': THROWER_ABI,
...
contract Multiply13 {
    function multiply13(uint value) constant returns (uint) {
        return Library13.multiply13(value);
    }
}
"""))

MULTIPLY13_CONTRACT_CODE = "0x606060405260928060106000396000f3606060405260e060020a6000350463cdbf9c428114601a575b005b60896004357fcdbf9c42000000000000000000000000000000000000000000000000000000006060908152606482905260009073__Library13_____________________________9063cdbf9c42906084906020906024818660325a03f4156002575050604051519392505050565b50604051602090f3"

MULTIPLY13_CONTRACT_RUNTIME = "0x606060405260e060020a6000350463cdbf9c428114601a575b005b60896004357fcdbf9c42000000000000000000000000000000000000000000000000000000006060908152606482905260009073__Library13_____________________________9063cdbf9c42906084906020906024818660325a03f4156002575050604051519392505050565b50604051602090f3"

MULTIPLY13_CONTRACT_ABI = json.loads('[{"constant":true,"inputs":[{"name":"value","type":"uint256"}],"name":"multiply13","outputs":[{"name":"","type":"uint256"}],"type":"function"}]')
